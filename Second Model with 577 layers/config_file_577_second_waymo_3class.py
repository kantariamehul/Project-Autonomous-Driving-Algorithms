...
#data_root = '/data/cmpe249-f20/WaymoKittitMulti/trainall/'
data_root ='/data/cmpe249-fa22/WaymoKitti/4c_train5678/' #'/data/cmpe249-fa21/4c_train5678/'#'/data/cmpe249-f20/WaymoKittitMulti/trainvalall4class/'
...
db_sampler = dict(
    ...
    points_loader=dict(
        type='LoadPointsFromFile', coord_type='LIDAR', load_dim=4, use_dim=[0, 1, 2, 3]))
...
total_epochs =30 #resumed epoch 36, iter 5580